...
{
    [RoutePrefix("api/inquirychequerun")]
    public class InquiryChequeRunController : ApiController
    {
        private readonly InquiryChequeRunDAL _dal = new InquiryChequeRunDAL();

        // PATH: /api/inquirychequerun/report/2026-01-01/2026-01-31/970
        [HttpGet]
        ...
        // QUERY: /api/inquirychequerun/report?fromDate=2026-01-01&toDate=2026-01-31&costCtr=970
        [HttpGet]
        [Route("report")]
        ...
        private IHttpActionResult ExecuteQuery(string fromDate, string toDate, string costCtr)
        {
            try
            {
                ...
                var data = _dal.GetInquiryChequeRun(fromDateFormatted, toDateFormatted, costCtr.Trim());
