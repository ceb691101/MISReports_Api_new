...
{
    [RoutePrefix("api/inquirymaterialrequisition")]
    public class InquiryMaterialRequisitionController : ApiController
    {
        private readonly InquiryMaterialRequisitionDAL _dal = new InquiryMaterialRequisitionDAL();

        // PATH: /api/inquirymaterialrequisition/report/2026-01-01/2026-01-31/100
        [HttpGet]
        ...
        // QUERY: /api/inquirymaterialrequisition/report?fromDate=2026-01-01&toDate=2026-01-31&costCtr=100
        [HttpGet]
        [Route("report")]
        ...
        private IHttpActionResult ExecuteQuery(string fromDate, string toDate, string costCtr)
        {
            try
            {
                ...
                var data = _dal.GetInquiryMaterialRequisition(fromDateFormatted, toDateFormatted, costCtr.Trim());
