...
{
    [RoutePrefix("api/inquiryinventory")]
    public class InquiryInventoryController : ApiController
    {
        private readonly InquiryInventoryDAL _dal = new InquiryInventoryDAL();

        // PATH: /api/inquiryinventory/report/2026-01-01/2026-01-31/100
        [HttpGet]
        ...
        // QUERY: /api/inquiryinventory/report?fromDate=2026-01-01&toDate=2026-01-31&costCtr=100
        [HttpGet]
        [Route("report")]
        ...
        private IHttpActionResult ExecuteQuery(string fromDate, string toDate, string costCtr)
        {
            try
            {
                ...
                var data = _dal.GetInquiryInventory(fromDateFormatted, toDateFormatted, costCtr.Trim());
