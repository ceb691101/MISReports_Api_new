...
{
    [RoutePrefix("api/inquirycashbook")]
    public class InquiryCashBookController : ApiController
    {
        private readonly InquiryCashBookDAL _dal = new InquiryCashBookDAL();

        // PATH: /api/inquirycashbook/report/2026-01-01/2026-01-31/100
        [HttpGet]
        ...
        // QUERY: /api/inquirycashbook/report?fromDate=2026-01-01&toDate=2026-01-31&costCtr=100
        [HttpGet]
        [Route("report")]
        ...
        private IHttpActionResult ExecuteQuery(string fromDate, string toDate, string costCtr)
        {
            try
            {
                ...
                var data = _dal.GetInquiryCashBook(fromDateFormatted, toDateFormatted, costCtr.Trim());
