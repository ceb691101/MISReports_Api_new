...
{
    [RoutePrefix("api/inquirygeneralledger")]
    public class InquiryGeneralLedgerController : ApiController
    {
        private readonly InquiryGeneralLedgerDAL _dal = new InquiryGeneralLedgerDAL();

        // PATH: /api/inquirygeneralledger/report/2026-01-01/2026-01-31/100
        [HttpGet]
        ...
        // QUERY: /api/inquirygeneralledger/report?fromDate=2026-01-01&toDate=2026-01-31&costCtr=100
        [HttpGet]
        [Route("report")]
        ...
        private IHttpActionResult ExecuteQuery(string fromDate, string toDate, string costCtr)
        {
            try
            {
                ...
                var data = _dal.GetInquiryGeneralLedger(fromDateFormatted, toDateFormatted, costCtr.Trim());
