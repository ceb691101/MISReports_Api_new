...
{
    [RoutePrefix("api/cashbookinquirydrcr")]
    public class CashbookInquiryDrCrController : ApiController
    {
        private readonly CashbookInquiryDrCrDAL _dal = new CashbookInquiryDrCrDAL();

        // PATH: /api/cashbookinquirydrcr/report/2026-01-01/2026-01-31/510.00
        [HttpGet]
        ...
        // QUERY: /api/cashbookinquirydrcr/report?fromDate=2026-01-01&toDate=2026-01-31&costCtr=510.00
        [HttpGet]
        [Route("report")]
        ...
        private IHttpActionResult ExecuteQuery(string fromDate, string toDate, string costCtr)
        {
            try
            {
                ...
                var data = _dal.GetCashbookInquiryDrCr(fromDateFormatted, toDateFormatted, costCtr.Trim());
