...
{
    [RoutePrefix("api/inquirycashbookunpostedcancel")]
    public class InquiryCashBookUnpostedCancelController : ApiController
    {
        private readonly InquiryCashBookUnpostedCancelDAL _dal = new InquiryCashBookUnpostedCancelDAL();

        // PATH: /api/inquirycashbookunpostedcancel/report/2026-01-01/2026-01-31/100
        [HttpGet]
        ...
        // QUERY: /api/inquirycashbookunpostedcancel/report?fromDate=2026-01-01&toDate=2026-01-31&costCtr=100
        [HttpGet]
        [Route("report")]
        ...
        private IHttpActionResult ExecuteQuery(string fromDate, string toDate, string costCtr)
        {
            try
            {
                ...
                var data = _dal.GetInquiryCashBookUnpostedCancel(fromDateFormatted, toDateFormatted, costCtr.Trim());
