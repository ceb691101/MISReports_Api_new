...
{
    [RoutePrefix("api/docinquirygl")]
    public class DocInquiryGlController : ApiController
    {
        private readonly DocInquiryGlDAL _dal = new DocInquiryGlDAL();

        // PATH: /api/docinquirygl/report/2026-01-01/2026-01-31/970
        [HttpGet]
        ...
        // QUERY: /api/docinquirygl/report?fromDate=2026-01-01&toDate=2026-01-31&costCtr=970
        [HttpGet]
        [Route("report")]
        ...
        private IHttpActionResult ExecuteQuery(string fromDate, string toDate, string costCtr)
        {
            try
            {
                ...
                var data = _dal.GetDocInquiryGl(fromDateFormatted, toDateFormatted, costCtr.Trim());
